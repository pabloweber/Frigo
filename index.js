...
function getRecipes(){
	...
	var afterIngredients = '&number=100&mashape-key=0gbpW6Rs1ymshDLw1GaH2g0W8JOjp1x5kCQjsnPQ3FoiRkIu0D' //limitLicense=false&
	...
	for (var i = 0; i < recipes.length; i++) {
		...
		ingredientsMissing[i].innerHTML = "Number of missing ingredients: " + recipes[i].missedIngredientCount;
